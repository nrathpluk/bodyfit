...
import { BookIcon, ChartIcon, DumbbellIcon, ScaleIcon, UserIcon } from "./icons";
...
const TABS = [
  ...
  { href: "/diary", label: "อาหาร", Icon: BookIcon },
  { href: "/workouts", label: "ออกกำลัง", Icon: DumbbellIcon },
